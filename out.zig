...
pub const LUA_API = @compileError("unable to translate C expr: unexpected token 'extern'"); // ./libs/lua/lua-5.4.6/src/luaconf.h:288:9
pub const LUAI_FUNC = @compileError("unable to translate macro: undefined identifier `visibility`"); // ./libs/lua/lua-5.4.6/src/luaconf.h:316:9
pub const l_floor = @compileError("unable to translate macro: undefined identifier `floor`"); // ./libs/lua/lua-5.4.6/src/luaconf.h:409:9
pub const lua_numbertointeger = @compileError("unable to translate C expr: expected ')' instead got '='"); // ./libs/lua/lua-5.4.6/src/luaconf.h:423:9
pub const l_floatatt = @compileError("unable to translate macro: undefined identifier `DBL_`"); // ./libs/lua/lua-5.4.6/src/luaconf.h:466:9
pub const lua_str2number = @compileError("unable to translate macro: undefined identifier `strtod`"); // ./libs/lua/lua-5.4.6/src/luaconf.h:475:9
pub const lua_getlocaledecpoint = @compileError("unable to translate macro: undefined identifier `localeconv`"); // ./libs/lua/lua-5.4.6/src/luaconf.h:662:9
pub const LUAI_MAXALIGN = @compileError("unable to translate macro: undefined identifier `n`"); // ./libs/lua/lua-5.4.6/src/luaconf.h:773:9
...
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /usr/lib/zig/lib/include/stdarg.h:36:9
...
pub const luaL_newlibtable = @compileError("unable to translate C expr: unexpected token '('"); // ./libs/lua/lua-5.4.6/src/lauxlib.h:127:9
pub const luaL_addchar = @compileError("TODO postfix inc/dec expr"); // ./libs/lua/lua-5.4.6/src/lauxlib.h:207:9
pub const luaL_addsize = @compileError("unable to translate C expr: expected ')' instead got '+='"); // ./libs/lua/lua-5.4.6/src/lauxlib.h:211:9
pub const luaL_buffsub = @compileError("unable to translate C expr: expected ')' instead got '-='"); // ./libs/lua/lua-5.4.6/src/lauxlib.h:213:9
